...
describe('POST /sign-up', () => {
    it('should register a new user', async () => {
        const response = await (0, supertest_1.default)(app_1.default).post('/api/v1/users/sign-up').send({
...
describe('POST /login', () => {
    it('should login a user', async () => {
        const response = await (0, supertest_1.default)(app_1.default).post('/api/v1/users/sign-in').send({
            email: 'example@gmail.come',
            password: 'Ayuba@123'
        });
